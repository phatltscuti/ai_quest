...
# Generate new body with explicit short steps before each image, wrapped nicely
new_body = """
<div class="hero">
...
<div class="container">
  ...
  <section id="m3">
    ...
    <div class="card">
      ...
      <p style="margin-top:20px; font-weight: 600; color:var(--primary);">👉 Thao tác: Đăng nhập Google Stitch, chú ý phải chọn chế độ "Web" vì B2B cần màn hình to.</p>
      <div class="img-placeholder" data-target="step-01">
        <h4>📸 Chờ ảnh: Màn hình chủ Stitch</h4>
        <p>Lưu ảnh: <code>step-01-stitch-home.png</code></p>
      </div>
      <img src="images/step-01-stitch-home.png" class="img-real" alt="Stitch Home">

      <p style="margin-top:20px; font-weight: 600; color:var(--primary);">👉 Thao tác: Mở ứng dụng Ghi chú (Notepad), soạn sẵn 4 dòng định hướng trên (Ai sử dụng, Mục tiêu...).</p>
      <div class="img-placeholder" data-target="step-02">
        <h4>📸 Chờ ảnh: Tạo Note Brief</h4>
        <p>Lưu ảnh: <code>step-02-direction-brief.png</code></p>
      </div>
...
Avoid playful visuals and avoid marketing-style hero blocks. Focus on utility.</div>
      ...
      <p style="margin-top:20px; font-weight: 600; color:var(--primary);">👉 Thao tác: Copy đoạn Prompt vừa rồi, dán vào thanh tìm kiếm của Google Stitch.</p>
      <div class="img-placeholder" data-target="step-03">
        <h4>📸 Chờ ảnh: Prompt đầu tiên</h4>
        <p>Lưu ảnh: <code>step-03-first-prompt.png</code></p>
      </div>
      <img src="images/step-03-first-prompt.png" class="img-real" alt="First Prompt">

      <p style="margin-top:20px; font-weight: 600; color:var(--primary);">👉 Thao tác: Sau khi dán mã, nhấn nút Mũi tên Gửi (Enter) và đợi AI vẽ một bản thiết kế thô ráp.</p>
      <div class="img-placeholder" data-target="step-04">
        <h4>📸 Chờ ảnh: Rough Mockup</h4>
        <p>Lưu ảnh: <code>step-04-rough-mockup.png</code></p>
      </div>
      <img src="images/step-04-rough-mockup.png" class="img-real" alt="Rough Mockup">

      <p style="margin-top:20px; font-weight: 600; color:var(--primary);">👉 Thao tác: Chỉnh sửa cục bộ bằng cách click thẳng vào một phần tử trên giao diện (Vd: Bảng Table) và ra lệnh đổi màu cho cột Trạng thái thành Đỏ/Vàng.</p>
      <div class="img-placeholder" data-target="step-05">
        <h4>📸 Chờ ảnh: Các prompt tinh chỉnh cục bộ</h4>
        <p>Lưu ảnh: <code>step-05-iteration-prompts.png</code></p>
      </div>
...
Prioritize consistency, auditability, and enterprise clarity over decoration. Generate a DESIGN.md containing these precise metrics and hex codes.</div>
      ...
      <p style="margin-top:20px; font-weight: 600; color:var(--primary);">👉 Thao tác: Copy mã phía trên gửi vào khung Chat để AI gom màu sắc, font chữ thành một Bảng hệ thống (Design System Board) nằm cạnh bản nháp.</p>
      <div class="img-placeholder" data-target="step-06">
        <h4>📸 Chờ ảnh: Visual Board</h4>
        <p>Lưu ảnh: <code>step-06-design-system-board.png</code></p>
      </div>
      <img src="images/step-06-design-system-board.png" class="img-real" alt="Design System Board">

      <p style="margin-top:20px; font-weight: 600; color:var(--primary);">👉 Thao tác: Xin AI xuất luôn cho mình bộ quy tắc đó thành đoạn code <code>DESIGN.md</code> để đem về máy làm "luật".</p>
      <div class="img-placeholder" data-target="step-07">
        <h4>📸 Chờ ảnh: File DESIGN.md Code</h4>
        <p>Lưu ảnh: <code>step-07-design-md-panel.png</code></p>
      </div>
...
Keep the information architecture (KPIs, Tables, Sidemenu) exactly the same, only homogenize the visual language.</div>
      ...
      <p style="margin-top:20px; font-weight: 600; color:var(--primary);">👉 Thao tác: Chọn lại khung giao diện nháp ở Bước 3.2, dán mã bên trên yêu cầu AI áp dụng màu sắc và khoảng cách chuẩn từ DESIGN.md vào nháp.</p>
      <div class="img-placeholder" data-target="step-08">
        <h4>📸 Chờ ảnh: Apply Design System</h4>
        <p>Lưu ảnh: <code>step-08-apply-design-system.png</code></p>
      </div>
      <img src="images/step-08-apply-design-system.png" class="img-real" alt="Apply Design System">

      <p style="margin-top:20px; font-weight: 600; color:var(--primary);">👉 Thao tác: Dùng Paint đặt 2 màn hình (Bản xấu lúc đầu và Bản đẹp vừa render) nằm cạnh nhau để dễ xem sự khác biệt.</p>
      <div class="img-placeholder" data-target="step-09">
        <h4>📸 Chờ ảnh: So sánh Before/After</h4>
        <p>Lưu ảnh: <code>step-09-before-after.png</code></p>
      </div>
      <img src="images/step-09-before-after.png" class="img-real" alt="Before/After">

      <p style="margin-top:20px; font-weight: 600; color:var(--primary);">👉 Thao tác: Sang Google Stitch, bấm "Play / Preview" và rê chuột thử vào một nút bấm xem hiệu ứng tương tác (Hover chuột đổi màu).</p>
      <div class="img-placeholder" data-target="step-10">
        <h4>📸 Chờ ảnh: Trạng thái Hover (Prototype Check)</h4>
        <p>Lưu ảnh: <code>step-10-prototype-check.png</code></p>
      </div>
  ...
  <section id="m4">
    ...
    <div class="card">
      ...
      <p style="margin-top:20px; font-weight: 600; color:var(--primary);">👉 Thao tác: Bấm nút Code / Export trên góc phải màn hình để lấy mã nguồn HTML dán vào dự án.</p>
      <div class="img-placeholder" data-target="step-11">
        <h4>📸 Chờ ảnh: Export or Handoff</h4>
        <p>Lưu ảnh: <code>step-11-export-or-handoff.png</code></p>
      </div>
      <img src="images/step-11-export-or-handoff.png" class="img-real" alt="Export or Handoff">

      <p style="margin-top:20px; font-weight: 600; color:var(--primary);">👉 Thao tác: Gom toàn bộ file HTML cùng <code>DESIGN.md</code> và hình ảnh vào một thư mục dự án VS Code trên máy bạn và chụp kết quả thành quả.</p>
      <div class="img-placeholder" data-target="step-12">
        <h4>📸 Chờ ảnh: Môi trường Local (Final Result)</h4>
        <p>Lưu file cuối cùng: <code>step-12-final-result-local.png</code></p>
      </div>
